...
module Decidim
  module Verifications
    # This class serves as a DSL to declarative specify an authorization method.
    #
    # To define a direct verification method, you need to specify a
    # `Rectify::Form` that will be valid if the authorization is valid.
    #
    # To define a deferred verification method, you need to specify a full
    # `Rails::Engine` (and optionally another engine for the admin side). The
    # verification will succeed once the engine creates valid authorization for
    # the method with the `granted_at` column set in DB.
    #
